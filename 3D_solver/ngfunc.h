#ifndef NGFUNC_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define NGFUNC_H
...
public:
	NGfunc();
        ...
        Eigen::MatrixXd sumFilter(Eigen::MatrixXd phi);

        // run
        void Run(int n_process);
};
#endif